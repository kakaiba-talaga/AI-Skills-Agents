...
| `skills/ops/state-schema.md` (§ Anchor derivation for targeted `Edit` and § Status enum) | `skills/ops/phase-dispatch.md` (Step 1's fresh-read requirement cites the anchor-derivation section; Step 4's outcome table cites the status enum) |
