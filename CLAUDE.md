...
| `docs/agents-guide.md` | `agents/README.md` (runtime catalog + dispatch tables; extended usage, workflow, permissions — repo-only, not deployed) |
...
| `skills/ops/phase-dispatch.md` | `skills/ops/SKILL.md` (Phase 2.5b/2.5c/2.5/3, LB2, memory injection), `tooling/transform-cursor-ops.{ps1,sh}` |
...
| `docs/plan/token-efficiency-phase-b-execute-plan.md` | B1–B6 implementation checklist (executed 2026-05-26) |
...
| `docs/code-intel-integration-test.md` | `agents/code-intel.md`, `skills/ops/phase-dispatch.md` (Phase 2.5b), `skills/ops/phase-completion.md` (Phase 4 cleanup) |
