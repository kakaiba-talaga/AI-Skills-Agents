...
Extended usage examples, workflow details, and permission configuration for the agent catalog in [`agents/README.md`](../agents/README.md). Repo-only — not deployed (same as the catalog README).
