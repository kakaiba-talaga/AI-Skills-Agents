...
| :--- | ---: | :--- | :--- |
| `SKILL.md` | 341 | Argument parsing, workflow, stage discipline, all cross-references | Every invocation |
| `SKILL.cursor.md` | 345 | Cursor variant (drift baseline) | Cursor-side invocation |
...
| `work-item-scaffolding.md` | 20 | Template interaction, work-item discovery, completion-signal sub-cases | Frame stage (iter 1 scaffold), Reflect (work-item update) |
| `template-system.md` | 157 | Template resolution, YAML schema, template fields, read cadence | `--template` is used |
| `state-schema.md` | 122 | Complete JSON schema, field types, pruning policy | State init or troubleshooting |
